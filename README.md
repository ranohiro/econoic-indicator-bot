...
📊 Forex Factory Economic Calendar から重要経済指標を自動収集し、Discord Botで通知するシステム。完全無料・週次自動更新対応！

## 📋 概要

このツールは、Forex Factoryから経済指標を取得し、Discord Botで専用チャンネルに投稿します。

### 主な機能

- 🌍 **グローバル対応**: 全世界の経済指標を収集
- ⭐ **重要指標のみ**: インパクトが高い指標のみを自動フィルタリング
- 🕐 **日本時間表示**: ET→JST自動変換
